...
int main ()
{
    ...
    cout  << equals(line3D_1, line3D_1) << endl
          << equals(line3D_1, line3D_2) << endl
          << equals(line2D_1, line2D_1) << endl
          << equals(line2D_1, line2D_2) << endl
          << equals(pt2D_a, pt2D_a) << endl
          << equals(pt2D_a, pt2D_b) << endl
          << equals(pt3D_a, pt3D_a) << endl
          << equals(pt3D_a, pt3D_b) << endl;
